...
const fields =[
    ...
    {name: 'neme', elementName: 'input', type: 'text', placeholder: 'Your Name'},
...
export default connect(mapStateToProps,mapDispatchToProps) (
    ...
    validationSchema: Yup.object().shape({
        ...
        password: Yup.string().min(8,'Password need to be 8 character long').required('You need to enter your password.'),
        password2: Yup.string().required('Please enter your password again'). test('pass-match', 'Passwords don\'t match', function(value){
